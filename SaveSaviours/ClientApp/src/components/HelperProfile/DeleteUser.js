...
const DeleteUser = () => {
  ...
  return (
    <>
      <Typography variant="subtitle2" component="h2" align="center" className={classes.helperDeleteSubtitle}>
      ...
      <Box align="center">
        <Button variant="outlined" className={classes.helperDeleteButton} onClick={() => deleteButtonClick()}>
      ...
      {deleteClicked && (
        <>
          ...
          <Box align="center">
            <Button variant="outlined" className={classes.helperDeleteButton} onClick={() => deleteConfirmationClick()}>
